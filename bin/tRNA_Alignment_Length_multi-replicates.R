...
### Write table
write.table(paste0(args[2], "_tRNA-read-alignment-lengths.txt"), x = length.summary.DF, quote = F, sep = "\t") # Write length summary as output
...
### Plot
pdf(paste0(args[2], "_tRNA-read-alignment-lengths.pdf"))
