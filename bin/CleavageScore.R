...
write.table(results.df, 
            file = paste0(args[3], "_all-cleavage-score.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
write.table(newdata, 
            file = paste0(args[3], "_high-cleavage-score.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf(file = paste0(args[3], "_high-cleavage-score.pdf"), width = pdf.width, height = 5)
