...
write.table(newdata.tsRNAs, 
            file = paste0(args[4], "_tsRNAs_low_pvalues.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf.width <- 7
pdf(file = paste0(args[4], "_tsRNAs_low_pvalues.pdf"), width = pdf.width, height = 5)
...
write.table(newdata.ncRNAs, 
            file = paste0(args[4], "_ncRNAs_low_pvalues.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf.width <- 7
pdf(file = paste0(args[4], "_ncRNAs_low_pvalues.pdf"), width = pdf.width, height = 5)
