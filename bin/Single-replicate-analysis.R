...
write.table(results.df, 
            file = paste0(args[2], "_all-features.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
write.table(newdata, 
            file = paste0(args[2], "_high-cleavage-score.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf(file = paste0(args[2], "_high-cleavage-score.pdf"), width = pdf.width, height = 5)
...
write.table(newdata, 
            file = paste0(args[2], "_high-distribution-score.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf(file = paste0(args[2], "_high-distribution-score.pdf"), width = pdf.width, height = 5)
...
write.table(newdata, 
            file = paste0(args[2], "_high-slope-score.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf.width <- 7
pdf(file = paste0(args[2], "_high-slope-score.pdf"), width = pdf.width, height = 5)
...
write.table(newdata, 
            file = paste0(args[2], "_high-combined-score.tsv"),
            quote = FALSE, 
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE)
...
pdf.width <- 7
pdf(file = paste0(args[2], "_high-combined-score.pdf"), width = pdf.width, height = 5)
